...
(1,2007,5, 'Has impact or potential impact been determined? How has it been determined?', '4.2', '4. Context of the Organization', 'Potential impact on the organization’s ability to consistently provide products and services that meet customer and applicable statutory and regulatory requirements, the organization shall determine: 
1) the interested parties that are relevant to the quality management system; 
2) the requirements of these interested parties that are relevant to the quality management system.'),
(1,2007,6, 'Do you monitor and review the information about interested parties and their relevant requirements? How do you monitor this information?', '4.2', '4. Context of the Organization', 'The organization shall monitor and review the information about these interested parties and their relevant requirements.'),
(1,2007,7, 'Have the boundaries and applicability of the QMS been used to establish the scope of the organization? How have they been used?', '4.3', '4. Context of the Organization', 'The organization shall determine the boundaries and applicability of the quality management system to establish its scope'),
(1,2007,8, 'Have: The external and internal issues; The requirements of relevant interested parties and; The products and services of the organization been considered when determining the scope of the organization? How have they been considered?', '4.3', '4. Context of the Organization', 'When determining this scope, the organization shall consider: 
...
(1,2007,9, 'Has the application of the International Standard within the scope been determined? How has it been determined and how has it been applied by the organization?', '4.3', '4. Context of the Organization', 'Where a requirement of this International Standard within the determined scope can be applied, then 
it shall be applied by the organization.'),
(1,2007,10, 'Have any requirements of the International Standard been determined as not applicable? How were they determined as not applicable? Show how conformity of products and services are not affected by this.', '4.3', '4. Context of the Organization', 'If any requirement(s) of this International Standard cannot be applied, this shall not affect the organization’s ability or responsibility to ensure conformity of products and services.'),
(1,2007,11, 'Where is the scope available? Where is it maintained as documented information? 
...
(1,2007,12, 'How has the QMS been established? Show how this is implemented. How is it maintained and continually improved? How 
...
(1,2007,13, 'How have the processes been determined 
for the QMS? 
...
(1,2007,14, 'What documented information exists to support the operation of processes? How is this documented information retained? How is confidence that the processes are being carried out as planned determined?', '4.4', '4. Context of the Organization', 'The organization shall maintain documented information to the extent necessary to support the operation of processes and retain documented information to the extent necessary to have confidence that the processes are being carried out as planned.'),
(1,2007,15, 'Are supporting functions, whether on-site or remote (such as design centers, corporate headquarters, and distribution centers), included in the scope of the Quality Management System (QMS)? The only permitted exclusion for this Automotive QMS Standard relates to the product design and development requirements within ISO 9001, Section 8.3. Is the exclusion justified and maintained as documented information (see ISO 9001, Section 7.5)? Permitted exclusions do not include manufacturing process design.', '4.3.1', '4. Context of the Organization', 'The organization shall determine the boundaries and applicability of the quality management system to establish its scope'),
(1,2007,16, 'Are customer - specific requirements evaluated and included in the scope of the organization''s quality management system?', '4.3.2', '4. Context of the Organization', ''),
(1,2007,17, 'Has the organization ensured conformance of all products and processes, including service parts and those that are outsourced, to all applicable customer, statutory, and regulatory requirements (see Section 8.4.2.2)?', '4.4.1.1', '4. Context of the Organization', ''),
(1,2007,18, 'Does the organization have documented processes for the management of product-safety related products and manufacturing processes, which shall include but not be limited to the following, where applicable?:
...
13) lessons learned for new product introduction.', '4.4.1.2', '4. Context of the Organization', 'Note: Special approval is an additional approval by the function (typically the customer) that is responsible to approve such documents with safety - related content.'),
(1,2007,19, 'What documented information exists to support the operation of processes? How is this documented information retained? How is confidence that the processes are being carried out as planned determined?', '4.4', '4. Context of the Organization', 'The organization shall maintain documented information to the extent necessary to support the operation of processes and retain documented information to the extent necessary to have confidence that the processes are being carried out as planned.'),
(1,2007,20, 'How is the quality policy and objectives 
...
(1,2007,21, 'How is the quality policy communicated 
...
(1,2007,22, 'How do you promote awareness of the 
process approach?', '5.1.1', '5. Leadership', ''),
(1,2007,23, 'How do you ensure that resources needed 
for the QMS are available? ', '5.1.1', '5. Leadership', ''),
(1,2007,24, 'How do you communicate the importance 
of effective quality management?', '5.1.1', '5. Leadership', ''),
(1,2007,25, 'How do you communicate the importance of conforming to the QMS requirements? How do you ensure that the QMS achieves its intended results?', '5.1.1', '5. Leadership', ''),
(1,2007,26, 'How do you engage, direct and support people to contribute to the effectiveness of the QMS? ', '5.1.1', '5. Leadership', ''),
(1,2007,27, 'How do you promote continual improvement? How do you support other relevant management roles to demonstrate leadership in their areas of responsibility?', '5.1.1', '5. Leadership', ''),
(1,2007,29, 'How does top management establish, review and maintain a quality policy? 
...
(1,2007,30, 'Where is the quality policy available as documented information? 
...
(1,2007,31, 'How does top management ensure that responsibilities and authorities for relevant roles are assigned, communicated and understood within the organization?', '5.3', '5. Leadership', 'Top management shall ensure that the responsibilities and authorities for relevant roles are assigned, communicated and understood within the organization.'),
(1,2007,32, 'How does top management assign the responsibility and authority for: Ensuring that the QMS conforms to the International standard? ', '5.3', '5. Leadership', 'Top management shall assign the responsibility and authority for: 
...
(1,2007,33, 'How is the performance of the QMS,opportunities for improvement and the need for change or innovation reported to top management? ', '5.3', '5. Leadership', 'Top management shall assign the responsibility and authority for: 
...
(1,2007,34, 'How is customer focus promoted within the organization? ', '5.3', '5. Leadership', 'Top management shall assign the responsibility and authority for: 
1) ensuring that the quality management system conforms to the requirements of this International Standard; 
2) ensuring that the processes are delivering their intended outputs; 
3) reporting on the performance of the quality management system, on opportunities for improvement and on the need for change or innovation, and especially for reporting to top management; 
4) ensuring the promotion of customer focus throughout the organization; 
5) ensuring that the integrity of the quality management system is maintained when changes to the quality management system are planned and implemented.'),
(1,2007,35, 'How is the integrity of the QMS maintained when changes to the QMS are planned and 
...
4) ensuring the promotion of customer focus throughout the organization; 
5) ensuring that the integrity of the quality management system is maintained when changes to the quality management system are planned and implemented.'),
(1,2007,6, 'Has the organization defined and implemented corporate responsibility policies, including at a minimum an anti-bribery policy, an employee code of conduct, and an ethics escalation policy ("whistle - blowing policy")?', '5.1.1.1', '5. Leadership', ''),
(1,2007,7, 'Has top management reviewed the product realization processes and support processes to evaluate and improve their effectiveness and efficiency? Are the results of the process review activities included as input to the management review (see Section 9.3.2.1)?', '5.1.1.2', '5. Leadership', ''),
(1,2007,8, 'Has top management identified process owners who are responsible for managing the organization''s processes and related outputs? Do process owners understand their roles and are they competent to perform those roles (see ISO 9001, Section 7.2)?', '5.1.1.3', '5. Leadership', ''),
(1,2007,9, 'Has top management assigned personnel with the responsibility and authority to ensure that customer requirements are met? Have these assignments been documented? This includes but is not limited to the selection of special characteristics, setting quality objectives and related training, corrective and preventive actions, product design and development, capacity analysis, logistics information, customer scorecards, and customer portals.', '5.3.1', '5. Leadership', ''),
(1,2007,10, 'Has top management ensured that: a) personnel responsible for conformity to product requirements have the authority to stop shipment and stop production to correct quality problems?; NOTE: Due to the process design in some industries, it might not always be possible to stop production immediately. In this case, the affected batch must be contained and shipment to the customer prevented. b) personnel with authority and responsibility for corrective action are promptly informed of products or processes that do not conform to requirements to ensure that nonconforming product is not shipped to the customer and that all potential nonconforming product is identified and contained; c) production operations across all shifts are staffed with personnel in charge of, or delegated responsibility for, ensuring conformity to product requirements', '5.3.2', '5. Leadership', ''),
(1,2007,36, 'How are the internal and external issues and interested parties considered when planning for the QMS? ', '6.1.1', '6. Planning for the quality management system', '1) give assurance that the quality management system can achieve its intended result(s); 
2) prevent, or reduce, undesired effects; 
3) achieve continual improvement.'),
(1,2007,37, 'How are actions planned to address risks and opportunities? 
...
(1,2007,38, 'How are actions taken to address risks and opportunities determined as being 
...
(1,2007,39, 'How do you determine that personnel with product design responsibility are competent 
...
(1,2007,40, 'Where are the quality objectives and are these at all relevant functions, levels and processes? ', '6.2.1', '6. Planning for the quality management system', 'The quality objectives shall: 
...
(1,2007,41, 'Are they consistent with the quality policy? 
...
7) be updated as appropriate. 
The organization shall retain documented information on the quality objectives.'),
(1,2007,42, 'Are they relevant to the conformity of products and services and do they enhance customer satisfaction? 
...
7) be updated as appropriate. 
The organization shall retain documented information on the quality objectives.'),
(1,2007,43, 'How are they communicated? 
...
7) be updated as appropriate. 
The organization shall retain documented information on the quality objectives.'),
(1,2007,44, 'How does the organization determine what will be done, with what resources, when 
...
(1,2007,45, 'How are changes to the QMS planned systematically? ', '6.3', '6. Planning for the quality management system', 'The organization shall consider: 
...
(1,2007,11, 'Has the organization included in its risk analysis, at a minimum, lessons learned from product recalls, product audits, field returns and repairs, complaints, scrap, and rework? Has the organization retained documented information as evidence of the results of risk analysis?', '6.1.2.1', '6. Planning for the quality management system', ''),
(1,2007,12, 'Has the organization determined and implemented action(s) to eliminate the causes of potential nonconformities in order to prevent their occurrence? Are preventive actions appropriate to the severity of the potential issues? Has the organization established a process to lessen the impact of negative effects of risk including the following: 
...
6) utilizing lessons learned to prevent recurrence in similar processes (see ISO 9001, Section 7.1.6)?', '6.1.2.2', '6. Planning for the quality management system', ''),
(1,2007,13, 'Has the organization: 
...
7) documented the contingency plans and retained documented information describing any revision(s), including the person(s) who authorized the change(s). Do the contingency plans include provisions to validate that the manufactured product continues to meet customer specifications after the re-start of production following an emergency in which production was stopped and if the regular shutdown processes were not followed?', '6.1.2.3', '6. Planning for the quality management system', ''),
(1,2007,14, 'Has top management ensured that quality objectives to meet customer requirements are defined, established, and maintained for relevant functions, processes, and levels throughout the organization? Are the results of the organization''s review regarding interested parties and their relevant requirements considered when the organization establishes its annual (at a minimum) quality objectives and related performance targets (internal and external)?', '6.2.2.1', '6. Planning for the quality management system', ''),
(1,2007,46, 'how resources are determined for the establishment, implementation, maintenance and continual improvement of the QMS. ', '7.1.1', '7. Support', 'The organization shall consider: 
1) the capabilities of, and constraints on, existing internal resources; 
2) what needs to be obtained from external providers'),
(1,2007,47, 'how the capabilities and constraints on internal resources are considered. ', '7.1.1', '7. Support', 'The organization shall consider: 
1) the capabilities of, and constraints on, existing internal resources; 
2) what needs to be obtained from external providers'),
(1,2007,48, 'how needs from external providers are considered.', '7.1.1', '7. Support', 'The organization shall consider: 
1) the capabilities of, and constraints on, existing internal resources; 
2) what needs to be obtained from external providers'),
(1,2007,49, 'How do you provide persons necessary to consistently meet customer, applicable statutory and regulatory requirements for the QMS including the necessary processes?', '7.1.2', '7. Support', 'To ensure that the organization can consistently meet customer and applicable statutory and regulatory requirements, the organization shall provide the persons necessary for the effective operation of the quality management system, including the processes needed.'),
(1,2007,50, 'The organization shall determine, provide and maintain the infrastructure for the operation of its processes to achieve conformity of products and services.', '7.1.3', '7. Support', 'Any product realization change affecting customer requirements requires notification to, and agreement from, the customer'),
(1,2007,51, 'How do you determine, provide and maintain the environment for the operation 
...
(1,2007,52, 'How are the resources determined for ensuring valid and reliable monitoring and 
...
(1,2007,53, 'How do you ensure that resources provided are suitable for the specific monitoring and measurement activities and are maintained to ensure continued fitness ', '7.1.5', '7. Support', 'The organization shall ensure that the resources provided: 
...
(1,2007,57, 'How do you determine necessary knowledge for the operation of processes? How do you determine necessary knowledge to achieve conformity of products and services?', '7.1.6', '7. Support', 'The organization shall determine the knowledge necessary for the operation of its processes and to achieve conformity of products and services'),
(1,2007,58, 'How do you maintain this knowledge and how do you make it available to the extent necessary?', '7.1.6', '7. Support', 'This knowledge shall be maintained, and made available to the extent necessary.'),
(1,2007,54, 'How do you consider current knowledge and how do you acquire additional knowledge when addressing changing needs and trends?', '7.1.6', '7. Support', 'When addressing changing needs and trends, the organization shall consider its current knowledge and determine how to acquire or access the necessary additional knowledge.'),
(1,2007,55, 'How do You determine the necessary competence of people doing work under your control that affects quality performance; How do you determine competence on the basis of appropriate education, training or 
...
(1,2007,57, 'How do you determine internal and external communications relevant to the QMS? How do you determine: What? When? With Whom? How?', '7.4', '7. Support', 'The organization shall determine the internal and external communications relevant to the quality management system including: 
1) on what it will communicate; 
2) when to communicate; 
3) with whom to communicate; 
4) how to communicate'),
(1,2007,58, 'What documented information do you have as required by this standard? What documented information do you have as being necessary for the effectiveness of your QMS?', '7.5.1', '7. Support', 'The organization’s quality management system shall include: 
...
(1,2007,60, 'Show how you control documented information. Show how you make it available and suitable for use. How do you protect your documented information?', '7.5.3.1', '7. Support', 'Documented information required by the quality management system and by this International Standard shall be controlled to ensure: 
...
(1,2007,61, 'When controlling documented information, how do you address: 
...
6) executing a minimum number of audits per year, as defined by the organization; and g) maintaining knowledge of relevant requirements based on internal changes (e.g. process technology, product technology) and external changes (e.g. ISO 9001, IATF 16949, core tools, and customer specific requirements)?', '7.2.3', '7. Support', ''),
(1,2007,24, 'Does the organization demonstrate the competence of the auditors undertaking the second-party audits? Do second-party auditors meet customer specific requirements for auditor qualification and demonstrate the minimum following core competencies, including understanding of: 
...
5) applicable core tool requirements related to the scope of the audit; f) how to plan, conduct, prepare audit reports, and close out audit findings?', '7.2.4', '7. Support', ''),
(1,2007,25, 'Does the organization maintain documented information that demonstrates that all employees are aware of their impact on product quality and the importance of the activities in achieving, maintaining, and improving quality, including customer requirements and the risks involved for the customer with non-conforming product?', '7.3.1', '7. Support', ''),
(1,2007,26, 'Does the organization maintain a documented process(es) to motivate employees to achieve quality objectives, to make continual improvements, and to create an environment that promotes innovation? Does the process include the promotion of quality and technological awareness throughout the whole organization?', '7.3.2', '7. Support', ''),
(1,2007,27, 'Is the organization''s quality management system documented and includes a quality manual, which can be a series of documents (electronic or hard copy)? Is the format and structure of the quality manual at the discretion of the organization and does it depend on the organization''s size, culture, and complexity? If a series of documents is used, is a list retained of the documents that comprise the quality manual for the organization? Does the quality manual include, at a minimum, the following: 
...
4) a document (i.e.. matrix) indicating where within the organization''s quality management system their customer-specific requirements are addressed?', '7.5.1.1', '7. Support', 'NOTE: A matrix of how the requirements of this Automotive QMS standard are addressed by the organization''s processes may be used to assist with linkages of the organization''s processes and this Automotive QMS.'),
(1,2007,28, 'Does the organization define, document, and implement a record retention policy? Do the control of records satisfy statutory, regulatory, organizational, and customer requirements? Are production part approvals, tooling records (including maintenance and ownership), product and process design records, purchase orders (if applicable), or contracts and amendments retained for the length of time that the product is active for production and service requirements, plus one calendar year, unless otherwise specified by the customer or regulatory agency?', '7.5.3.2.1', '7. Support', 'NOTE: Production part approval documented information may include approved product, applicable test equipment records, or approved test data.'),
(1,2007,29, 'Does the organization have a documented process describing the review, distribution, and implementation of all customer engineering standards/specifications and related revisions based on customer schedules, as required? When an engineering standard/specification change results in a product design change, refer to the requirements in ISO 9001, Section 8.3.6. When an engineering standard/specification change results in a product realization process change, refer to the requirements in Section 8.5.6.1. Does the organization retain a record of the date on which each change is implemented in production? Does implementation include updated documents? Is review completed within 10 working days of receipt of notification of engineering standards/specification changes?', '7.5.3.2.2', '7. Support', 'NOTE: A change in these standards / specifications may require an updated record of customer production part approval when these specifications are referenced on the design record or if they affect documents of the production part approval process, such as control plan, risk analysis (such as FMEAs), etc.'),
(1,2007,63, 'How are processes needed to meet requirements for provision of products and services planned, implemented and controlled? How are requirements for products and services determined? How is criteria for processes and acceptance for products and services determined? How are resources determined? How is process control implemented?  the documented information that shows confidence in that the processes have been carried out as planned and can demonstrate conformity of products and services.', '8.1', '8. Operation', '1) determining requirements for the product and services; 
...
(1,2007,64, 'How have you determined that the output from the planning process is suitable for your operations?', '8.1', '8. Operation', 'The output of this planning shall be suitable for the organization''s operations.'),
(1,2007,65, 'How do you control planned changes? How do you review the consequences of unintended changes? What action is taken to mitigate any adverse effects?', '8.1', '8. Operation', 'The organization shall control planned changes and review the consequences of unintended changes, taking action to mitigate any adverse effects, as necessary'),
(1,2007,66, 'How do you control outsourced processes?', '8.1', '8. Operation', 'The organization shall ensure that outsourced processes are controlled in accordance with 8.4.'),
(1,2007,67, 'What are your processes for communicating with customers? How do you communicate information relating to: Products; Services; Enquiries; Contracts; Order handling; customer views, perceptions and complaints; Handling or treatment of customer 
...
(1,2007,68, 'What is your process to determine the requirements for products and services to be offered to potential customers? How do 
...
(1,2007,77, ' show how you determine: 
...
(1,2007,78, 'How do you determine that inputs are adequate, complete and unambiguous for design and development? How do you 
...
(1,2007,80, 'How do you ensure that design and development outputs: Meet the input requirements for design and development? Are adequate for the subsequent processes for the provision of products and services? Include or reference monitoring and measuring requirements, and acceptance criteria, as applicable? 
...
(1,2007,81, ' the documented information which results from the design and development process.', '8.3.5', '8. Operation', 'The organization shall retain the documented information resulting from the design and development process.'),
(1,2007,82, 'How do you review, control and identify changes made to the design inputs and outputs during design and development of products and services ensuring no impact on conformity to requirements?', '8.3.6', '8. Operation', 'The organization shall review, control and identify changes made to design inputs and design outputs during the design and development of products and services or subsequently, to the extent that there is no adverse impact on conformity to requirements'),
(1,2007,83, 'Show the documented information for design and development changes.', '8.3.6', '8. Operation', 'Documented information on design and development changes shall be retained.'),
(1,2007,84, 'How do you ensure externally provided processes, products and services conform to specified requirements?', '8.4.1', '8. Operation', 'The organization shall ensure that externally provided processes, products, and services conform to specified requirements'),
(1,2007,85, ' how you apply specified requirements for the control of externally provided products and services when: Products and services are provided by external providers for incorporation into your own products and services; You provide products and services directly to customers by external providers on your behalf; A process or part-process is provided by an external provider as a result of a decision to outsource a process or function.', '8.4.1', '8. Operation', '1) products and services are provided by external providers for incorporation into the organization’s own products and services; 
...
(1,2007,92, 'Before you communicate with external providers, how do you ensure the adequacy of specified requirements?', '8.4.3', '8. Operation', 'The organization shall ensure the adequacy of specified requirements prior to their communication to the external provider.'),
(1,2007,93, 'What controlled conditions do you have for production and service provision, including delivery and post-delivery activities?', '8.5.1', '8. Operation', 'The organization shall implement controlled conditions for production and service provision, including delivery and post-delivery activities.'),
(1,2007,94, ' show controlled conditions for: 
...
(1,2007,95, ' show controlled conditions for: 
...
7) the validation, and periodic revalidation, of the ability to achieve planned results of any process for production and service provision where the resulting output cannot be verified by subsequent monitoring or measurement; 
8) the implementation of products and services release, delivery and post-delivery activities.'),
(1,2007,97, 'What means do you use to identify process outputs to ensure conformity of products and services?', '8.5.2', '8. Operation', 'Where necessary to ensure conformity of products and services, the organization shall use suitable means to identify process outputs.'),
(1,2007,98, 'How do you identify the status of process outputs?', '8.5.2', '8. Operation', 'The organization shall identify the status of process outputs with respect to monitoring and measurement requirements throughout production and service provision.'),
(1,2007,99, 'How do you control the unique identification of process outputs, where applicable? What documented information do you retain?', '8.5.2', '8. Operation', 'Where traceability is a requirement, the organization shall control the unique identification of the process outputs, and retain any documented information necessary to maintain traceability'),
(1,2007,100, 'What care do you provide for customer or external provider’s property while under your control? 
...
(1,2007,103, 'How do you meet requirements for post- delivery activities associated with products and services?', '8.5.5', '8. Operation', 'As applicable, the organization shall meet requirements for post-delivery activities associated with the products and services.'),
(1,2007,104, 'How do you determine: Risk; Nature, use and intended lifetime; Customer feedback; 
...
(1,2007,112, 'How do you verify conformance where process outputs, products and services are corrected following nonconformance?', '8.7', '8. Operation', 'Where nonconforming process outputs, products and services are corrected, conformity to the requirements shall be verified.'),
(1,2007,113, 'What documented information do you keep following actions taken to address nonconformities, including any concessions obtained and on the person or authority that made the decision regarding dealing with the nonconformance.', '8.7', '8. Operation', 'The organization shall retain documented information of actions taken on nonconforming process outputs, products and services, including on any concessions obtained and on the person or authority that made the decision regarding dealing with the nonconformity.'),
(1,2007,30, 'When planning for product realization, are the following topics included: a) customer product requirements and technical specifications; b) logistics requirements; c) manufacturing feasibility; d) project planning (refer to ISO 9001, Section 8.3.2); e) acceptance criteria? The resources identified in ISO 9001, Section 8.1 c), refer to the required verification, validation, monitoring, measurement, inspection, and test activities specific to the product and the criteria for product acceptance.', '8.1.1', '8. Operation', ''),
(1,2007,31, 'Has the organization ensured the confidentiality of customer-contracted products and projects under development, including related product information?', '8.1.2', '8. Operation', ''),
(1,2007,32, 'Is written or verbal communication in the language agreed with the customer? Does the organization have the ability to communicate necessary information, including data in a customer-specified computer language and format (e.g. computer-aided design data, electronic data interchange)?', '8.2.1.1', '8. Operation', ''),
(1,2007,33, 'Do these requirements include recycling, environmental impact, and characteristics identified as a result of the organization''s knowledge of the product and manufacturing processes? Does compliance to ISO 9001, Section 8.2.2 item a) 1), include but not limited to the following: all applicable government, safety, and environmental regulations related to acquisition, storage, handling, recycling, elimination, or disposal of material?', '8.2.2.1', '8. Operation', ''),
(1,2007,34, 'Does the organization retain documented evidence of a customer-authorized waiver for the requirements stated in ISO 9001, Section 8.2.3.1, for a formal review?', '8.2.3.1.1', '8. Operation', ''),
(1,2007,35, 'Does the organization conform to customer requirements for designation, approval documentation, and control of special characteristics?', '8.2.3.1.2', '8. Operation', ''),
(1,2007,36, 'Does the organization utilize a multidisciplinary approach to conduct an analysis to determine if it is feasible that the organization''s manufacturing processes are capable of consistently producing product that meets all of the engineering and capacity requirements specified by the customer? Does the organization conduct this feasibility analysis for any manufacturing or product technology new to the organization and for any changed manufacturing process or product design? Additionally, does the organization validate through production runs, benchmarking studies, or other appropriate methods, their ability to make product to specifications at the required rate?', '8.2.3.1.3', '8. Operation', ''),
(1,2007,37, 'Do the requirements of ISO 9001, Section 8.3.1, apply to product and manufacturing process design and development and focus on error prevention rather than detection? Does the organization document the design and development process?', '8.3.1.1', '8. Operation', ''),
(1,2007,38, 'Does the organization ensure that design and development planning includes all affected stakeholders within the organization and, as appropriate, its supply chain? Examples of areas for using such a multidisciplinary approach include but are not limited to the following: a) project management (for example, APQP or VDA - RGA); b) product and manufacturing process design activities (for example, DFM and DFA), such as consideration of the use of alternative designs and manufacturing processes; c) development and review of product design risk analysis (FMEAs), including actions to reduce potential risks; d) development and review of manufacturing process risk analysis (for example, FMEAs, process flows, control plans, and standard work instructions).', '8.3.2.1', '8. Operation', 'NOTE: A multidisciplinary approach typically includes the organization''s design, manufacturing, engineering, quality, production, purchasing, supplier, maintenance, and other appropriate functions.'),
(1,2007,39, 'Does the organization ensure that personnel with product design responsibility are competent to achieve design requirements and are skilled in applicable product design tools and techniques? Are applicable tools and techniques identified by the organization?', '8.3.2.2', '8. Operation', 'NOTE: An example of product design skills is the application of digitized mathematically based data.'),
(1,2007,40, 'Does the organization use a process for quality assurance for their products with internally developed embedded software? Is a software development assessment methodology utilized to assess the organization''s software development process? Using prioritization based on risk and potential impact to the customer, does the organization retain documented information of a software development capability self-assessment? Does the organization include software development within the scope of their internal audit programme (see Section 9.2.2.1)?', '8.2.2.3', '8. Operation', ''),
(1,2007,41, 'Does the organization identify, document, and review product design input requirements as a result of contract review? Do product design input requirements include but not limited to the following: 
...
8) embedded software requirements? Does the organization have a process to deploy information gained from previous design projects, competitive product analysis (benchmarking), supplier feedback, internal input, field data, and other relevant sources for current and future projects of a similar nature?', '8.3.3.1', '8. Operation', 'NOTE: One approach for considering design alternatives is the use of trade-off curves.'),
(1,2007,42, 'Does the organization identify, document, and review manufacturing process design input requirements including but not limited to the following: 
...
5) special status customer notifications related to quality or delivery issues; f) dealer returns, warranty, field actions, and recalls?', '8.4.2.4 ', '8. Operation', ''),
(1,2007,59, 'Does the organization include a second-party audit process in their supplier management approach? Second-party audits may be used for the following: 
1) supplier risk assessment; 
2) supplier monitoring; 
3) supplier QMS development; 
4) product audits; 
5) process audits. Based on a risk analysis, including product safety/regulatory requirements, performance of the supplier, and QMS certification level, at a minimum, does the organization document the criteria for determining the need, type, frequency, and scope of second-party audits? Does the organization retain records of the second-party audit reports? If the scope of the second-party audit is to assess the supplier''s quality management system, is the approach consistent with the automotive process approach?', '8.4.2.4.1', '8. Operation', 'NOTE: Guidance may be found in the IATF Auditor Guide and ISO 19011.'),
(1,2007,60, 'Does the organization determine the priority, type, extent, and timing of required supplier development actions for its active suppliers? Do determination inputs include but are not limited to the following: 
...
9) at a set frequency based on a risk analysis? If required by the customer, does the organization obtain customer approval after review or revision of the control plan?', '8.5.1.1 ', '8. Operation', ''),
(1,2007,63, 'Does the organization ensure that standardized work documents are: 
...
4) verification that personnel making appearance evaluations are competent and qualified to do so?', '8.6.3 ', '8. Operation', ''),
(1,2007,77, 'Does the organization have a process to ensure the quality of externally provided processes, products, and services utilizing one or more of the following methods: a) receipt and evaluation of statistical data provided by the supplier to the organization; b) receiving inspection and/or testing, such as sampling based on performance; c) second-party or third-party assessments or audits of supplier sites when coupled with records of acceptable delivered product conformance to requirements; d) part evaluation by a designated laboratory; e) another method agreed with the customer?', '8.6.4 ', '8. Operation', ''),
(1,2007,78, 'Prior to release of externally provided products into its production flow, does the organization confirm and is it able to provide evidence that externally provided processes, products, and services conform to the latest applicable statutory, regulatory, and other requirements in the countries where they are manufactured and in the customer-identified countries of destination, if provided?', '8.6.5', '8. Operation', ''),
(1,2007,79, 'Is acceptance criteria defined by the organization and, where appropriate or required, approved by the customer? For attributed data sampling, is the acceptance level zero defects (see Section 9.1.1.1)?', '8.6.6 ', '8. Operation', ''),
(1,2007,80, 'Does the organization obtain a customer concession or deviation permit prior to further processing whenever the product or manufacturing process is different from that which is currently approved? Does the organization obtain customer authorization prior to further processing for "use as is" and rework dispositions of nonconforming product? If sub-components are reused in the manufacturing process, is that sub-component reuse clearly communicated to the customer in the concession or deviation permit? Does the organization maintain a record of the expiration date or quantity authorized under concession? Does the organization also ensure compliance with the original or superseding specifications and requirements when the authorization expires? Is material shipped under concession properly identified on each shipping container (this applies equally to purchased product)? Does the organization approve any requests from suppliers before submission to the customer?', '8.7.1.1 ', '8. Operation', ''),
(1,2007,81, 'Does the organization comply with applicable customer-specified controls for nonconforming product(s)?', '8.7.1.2 ', '8. Operation', ''),
(1,2007,82, 'Does the organization ensure that product with unidentified or suspect status is classified and controlled as nonconforming product? Does the organization ensure that all appropriate manufacturing personnel receive training for containment of suspect and nonconforming product?', '8.7.1.3 ', '8. Operation', ''),
(1,2007,83, 'Does the organization utilize risk analysis (such as FMEA) methodology to assess risks in the rework process prior to a decision to rework the product? If required by the customer, does the organization obtain approval from the customer prior to commencing rework of the product? Does the organization have a documented process for rework confirmation in accordance with the control plan or other relevant documented information to verify compliance to original specifications? Are instructions for disassembly or rework, including re-inspection and traceability requirements, accessible to and utilized by the appropriate personnel? Does the organization retain documented information on the disposition of reworked product including quantity, disposition, disposition date, and applicable traceability information?', '8.7.1.4', '8. Operation', ''),
(1,2007,84, 'Does the organization utilize risk analysis (such as FMEA) methodology to assess risks in the repair process prior to a decision to repair the product? Does the organization obtain approval from the customer before commencing repair of the product? Does the organization have a documented process for repair confirmation in accordance with the control plan or other relevant documented information? Are instructions for disassembly or repair, including re-inspection and traceability requirements, accessible to and utilized by the appropriate personnel? Does the organization obtain a documented customer authorization for concession for the product to be repaired? Does the organization retain documented information on the disposition of repaired product including quantity, disposition, disposition date, and applicable traceability information?', '8.7.1.5', '8. Operation', ''),
(1,2007,85, 'Does the organization immediately notify the customer(s) in the event that nonconforming product has been shipped? Is initial communication followed with detailed documentation of the event?', '8.7.1.6', '8. Operation', ''),
(1,2007,86, 'Does the organization have a documented process for disposition of nonconforming product not subject to rework or repair? For product not meeting requirements, does the organization verify that the product to be scrapped is rendered unusable prior to disposal? The organization shall not divert nonconforming product to service or other use without prior customer approval.', '8.7.1.7 ', '8. Operation', ''),
(1,2007,114, 'Show how you determine: What needs to be monitored and measured? 
...
(1,2007,115, 'What documented information can you show that monitoring and measurement activities have been implemented in accordance with determined requirements?', '9.1.1', '9. Performance evaluation', 'The organization shall ensure that monitoring and measurement activities are implemented in accordance with the determined requirements and shall retain appropriate documented information as evidence of the results.'),
(1,2007,116, 'Show how you evaluate the quality performance and the effectiveness of the QMS.', '9.1.1', '9. Performance evaluation', 'The organization shall evaluate the quality performance and the effectiveness of the quality management system.'),
(1,2007,117, 'How do you monitor customer perception of the degree to which requirements have been met?', '9.1.2', '9. Performance evaluation', 'The organization shall monitor customer perceptions of the degree to which requirements have been met.'),
(1,2007,118, 'How do you obtain information relating to customer views and opinions of your products and services?', '9.1.2', '9. Performance evaluation', 'The organization shall obtain information relating to customer views and opinions of the organization and its products and services.'),
(1,2007,119, 'What methods for obtaining and using this information do you have?', '9.1.2', '9. Performance evaluation', 'The methods for obtaining and using this information shall be determined'),
(1,2007,120, 'Show how you analyze and evaluate data and information arising from monitoring, measurement and other sources.', '9.1.3', '9. Performance evaluation', 'The organization shall analyze and evaluate appropriate data and information arising from monitoring, measurement and other sources.'),
(1,2007,121, 'how the output of analysis and evaluation is used to: 
...
(1,2007,122, 'Show where the results of analysis and evaluation are used to provide inputs to management review.', '9.1.3', '9. Performance evaluation', 'The results of analysis and evaluation shall also be used to provide inputs to management review.'),
(1,2007,123, 'Are internal audits being conducted at planned intervals? Do they determine whether the QMS conforms to the requirements of ISO 9001 and to the other requirements established by Organization? 
...
(1,2007,124, 'Show audit programme(s) that takes into consideration the quality objectives, importance of the processes, customer feedback, changes impacting the organization and the results of previous audits? 
...
(1,2007,125, 'What is the frequency that top management reviews the organization''s QMS? How is the QMS deemed suitable, adequate and effective?', '9.3.1', '9. Performance evaluation', 'Top management shall review the organization''s quality management system, at planned intervals, to ensure its continuing suitability, adequacy, and effectiveness'),
(1,2007,126, 'What kinds of information are reviewed in management reviews? These must include: actions status of previous reviews; 
...
(1,2007,127, 'Show that management reviews include decisions and actions relating to: Continual improvement opportunities; The need for changes to the QMS including resource needs.', '9.3.2', '9. Performance evaluation', 'The outputs of the management review shall include decisions and actions related to: 
1) continual improvement opportunities; 
2) any need for changes to the quality management system, including resource needs.'),
(1,2007,128, 'Show what documented information you have as evidence of management reviews.', '9.3.2', '9. Performance evaluation', 'The organization shall retain documented information as evidence of the results of management reviews.'),
(1,2007,87, 'Does the organization perform process studies on all new manufacturing (including assembly or sequencing) processes to verify process capability and to provide additional input for process control, including those for special characteristics?', '9.1.1.1', '9. Performance evaluation', ''),
(1,2007,88, 'Does the organization determine the appropriate use of statistical tools? Does the organization verify that appropriate statistical tools are included as part of the advanced product quality planning (or equivalent) process and included in the design risk analysis (such as DFMEA) (where applicable), the process risk analysis (such as PFMEA), and the control plan?', '9.1.1.2', '9. Performance evaluation', ''),
(1,2007,89, 'Are statistical concepts, such as variation, control (stability), process capability, and the consequences of over-adjustment, understood and used by employees involved in the collection, analysis, and management of statistical data?', '9.1.1.3 ', '9. Performance evaluation', ''),
(1,2007,90, 'Is customer satisfaction with the organization monitored through continual evaluation of internal and external performance indicators to ensure compliance to the product and process specifications and other customer requirements? Are performance indicators based on objective evidence and include but not limited to the following: a) delivered part quality performance; b) customer disruptions; c) field returns, recalls, and warranty (where applicable); d) delivery schedule performance (including incidents of premium freight); e) customer notifications related to quality or delivery issues, including special status? Does the organization monitor the performance of manufacturing processes to demonstrate compliance with customer requirements for product quality and process efficiency? Does the monitoring include the review of customer performance data including online customer portals and customer scorecards, where provided?', '9.1.2.1 ', '9. Performance evaluation', ''),
(1,2007,91, 'Are trends in quality and operational performance compared with progress toward objectives and lead to action to support prioritization of actions for improving customer satisfaction?', '9.1.3.1', '9. Performance evaluation', ''),
(1,2007,92, 'Does the organization have a documented internal audit process? Does the process include the development and implementation of an internal audit programme that covers the entire quality management system including quality management system audits, manufacturing process audits, and product audits? Is the audit programme prioritized based upon risk, internal and external performance trends, and criticality of the process(es)? Where the organization is responsible for software development, does the organization include software development capability assessments in their internal audit programme? Is the frequency of audits reviewed and, where appropriate, adjusted based on occurrence of process changes, internal and external nonconformities, and/or customer complaints? Is the effectiveness of the audit programme reviewed as a part of management review?', '9.2.2.1', '9. Performance evaluation', ''),
(1,2007,93, 'Does the organization audit all quality management system processes over each three-year calendar period, according to an annual programme, using the process approach to verify compliance with this Automotive QMS Standard? Integrated with these audits, does the organization sample customer-specific quality management system requirements for effective implementation?', '9.2.2.2 ', '9. Performance evaluation', ''),
(1,2007,94, 'Does the organization audit all manufacturing processes over each three-year calendar period to determine their effectiveness and efficiency using customer-specified required approaches for process audits? Where not defined by the customer, does the organization determine the approach to be used? Within each individual audit plan, is each manufacturer process audited on all shifts where it occurs, including the appropriate sampling of the shift handover? Does the manufacturing process audit include an audit of the effective implementation of the process risk analysis (such as PFMEA), control plan, and associated documents?', '9.2.2.3 ', '9. Performance evaluation', ''),
(1,2007,95, 'Does the organization audit products using customer-specific required approaches at appropriate stages of production and delivery to verify conformity to specified requirements? Where not defined by the customer, does the organization define the approach to be used?', '9.2.2.4 ', '9. Performance evaluation', ''),
(1,2007,96, 'Is management review conducted at least annually? Is the frequency of management review(s) increased based on risk to compliance with customer requirements resulting from internal or external changes impacting the quality management system and performance-related issues?', '9.3.1.1 ', '9. Performance evaluation', ''),
(1,2007,97, 'Does input to management review include: 
...
11) actual field failures and their impact on safety or the environment?', '9.3.2.1 ', '9. Performance evaluation', ''),
(1,2007,98, 'Does top management document and implement an action plan when customer performance targets are not met?', '9.3.3.1', '9. Performance evaluation', ''),
(1,2007,129, 'How do you determine and select opportunities for improvement? What necessary actions have you implemented so that you have met customer requirements and enhanced customer satisfaction?', '10.1', '10. Improvement', 'The organization shall determine and select opportunities for improvement and implement necessary actions to meet customer requirements and enhance customer satisfaction'),
(1,2007,130, 'Show how you have: Improved processes to prevent nonconformities; 
...
(1,2007,131, 'When nonconformities occur, how You react; 
...
(1,2007,132, 'Show how correction actions were appropriate to the effects of the nonconformities encountered.', '10.2.1', '10. Improvement', 'Corrective actions shall be appropriate to the effects of the nonconformities encountered.'),
(1,2007,133, 'What documented information can you show as evidence of: The nature of the nonconformities and subsequent actions taken; The results of any corrective action', '10.2.2', '10. Improvement', 'The organization shall retain documented information as evidence of: 
1) the nature of the nonconformities and any subsequent actions taken; 
2) the results of any corrective action.'),
(1,2007,134, 'Demonstrate that you continually improve the suitability, adequacy and effectiveness of the QMS.', '10.3', '10. Improvement', 'The organization shall continually improve the suitability, adequacy, and effectiveness of the quality management system.'),
(1,2007,135, 'Demonstrate that outputs of analysis and evaluation and the outputs from management review are considered to confirm if there are areas of underperformance or opportunities that shall be addressed as part of continual improvement.', '10.3', '10. Improvement', 'The organization shall consider the outputs of analysis and evaluation, and the outputs from management review, to confirm if there are areas of underperformance or opportunities that shall be addressed as part of continual improvement.'),
(1,2007,136, 'What applicable tools and methodologies for investigation of the causes of underperformance and to support continual improvement are selected?', '10.3', '10. Improvement', 'Where applicable, the organization shall select and utilize applicable tools and methodologies for investigation of the causes of underperformance and for supporting continual improvement.'),
(1,2007,99, 'Does the organization have a documented process(es) for problem solving including: 
...
6) reviewing and, where necessary, updating the appropriate documented information (e.g. PFMEA, control plan). Where the customer has specified prescribed processes, tools, or systems for problem solving, does the organization use those processes, tools, or systems, unless otherwise approved by the customer?', '10.2.3 ', '10. Improvement', ''),
(1,2007,100, 'Does the organization have a documented process to determine the use of appropriate error-proofing methodologies? Are details of the method used documented in the process risk analysis (such as PFMEA) and are test frequencies documented in the control plan? Does the process include the testing of error-proofing devices for failure or simulated failure? Are records maintained? Are challenge parts, when used, identified, controlled, verified, and calibrated where feasible? Do error-proofing device failures have a reaction plan?', '10.2.4 ', '10. Improvement', ''),
(1,2007,101, 'When the organization is required to provide warranty for their product(s), does the organization implement a warranty management process? Does the organization include in the process a method for warranty part analysis, including NTF (no trouble found)? When specified by the customer, does the organization implement the required warranty management process?', '10.2.5 ', '10. Improvement', ''),
(1,2007,102, 'Does the organization perform analysis on customer complaints and field failures, including any returned parts, and does it initiate problem solving and corrective action to prevent recurrence? Where requested by the customer, does this include analysis of the interaction of embedded software of the organization''s product within the system of the final customer''s product? Does the organization communicate the results of testing/analysis to the customer and also within the organization?', '10.2.6 ', '10. Improvement', ''),
(1,2007,103, 'Does the organization have a documented process for continual improvement? Does the organization include in this process the following: 
...
3) risk analysis (such as FMEA)?', '10.3.1 ', '10. Improvement', 'NOTE: Continual improvement is implemented once manufacturing processes are statistically capable and stable or when product characteristics are predictable and meet customer requirements.')
